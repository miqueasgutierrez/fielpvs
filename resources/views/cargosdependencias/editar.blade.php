            ...
            @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-5 md:gap-8 mt-5 mx-7">
                        <div class="grid grid-cols-1">
                            ...
                            <input type="text"   class="form-control   @error('nombre') is-invalid @enderror"  id="nombre" name="nombre" placeholder="Ingrese el nombre de cargo"  value="{{ $cargo->nombre }}">
                                @error('nombre')
                                <span class="invalid-feedback" role="alert">
                                    <strong>El campo No puede estar vacio </strong>
                                </span>
                                 @enderror
                        </div>
