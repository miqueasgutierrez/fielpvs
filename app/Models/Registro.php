...
protected $fillable= ['cedula', 'nombres', 'apellidos','fecha_nacimiento','telefono','edad','genero','profesion','iglesia','pastor','circuito','zona','imagen','direccion','estado_civil','fecha_uncion','ministro_ungido']; 
