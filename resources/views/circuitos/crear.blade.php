				...
				<form action="{{ route('circuitos.store') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="grid grid-cols-1 md:grid-cols-1 gap-5 md:gap-8 mt-5 mx-7">
						<div class="grid grid-cols-1">
							<label for="exampleInputEmail1">Nombre de Circuitos:</label>
							<input type="text"   class="form-control   @error('nombre') is-invalid @enderror"  id="nombre" name="nombre" placeholder="Ingrese el nombre del circuito"  value="{{ old('nombre') }}">
